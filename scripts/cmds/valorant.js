...
module.exports = {
  sentVideos: [],
   ...
   config: {
     ...
     author: "Rajveer",
     cooldowns: 1,
    shortDescription: "Get Random videos of Valorant",
    longDescription: "",
    category: "video",
    dependencies: {
      "fs-extra": "",
  ...
  onStart: async function ({ api, event, message }) {
    try {
      ...
      const loadingMessage = await api.sendMessage("Loading Random Valorant Clip..💫", event.threadID, null, event.messageID);

      const apiKey = "AIzaSyAO1tuGus4-S8RJID51f8WJAM7LXz1tVNc";
      const playlistId = "PLaw6FN8v2PpC2XRgBRce08F3DP3j-gAIV";
      ...
      stream.on('end', () => {
        ...
        const message = {
          body: '📹 | Heres Your Random Valorant Clip 🧸',
