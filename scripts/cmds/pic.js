...
module.exports = {
  config: {
    name: "pic",
    author: "Rajveer X Saklipse",
    version: "9.0",
    shortDescription: "Search for images using Saklipse API",
    longDescription: "Search for high-quality images using Saklipse API and return a specified number of results.",
    category: "utility",
    guide: {
      vi: "",
      en: ">pic <image that you wanted to search> <number of results>"
    }
  },
  ...
  onStart: async function({ args, message, getLang }) {
    try {
      ...
      return message.reply({body: `Here are the top ${numResults} high-quality image results for "${query}" from Saklipse And Rajveer:`, attachment: attachments});
    } catch (error) {
      console.error(error);
